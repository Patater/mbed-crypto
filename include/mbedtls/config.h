 ...
 * #MBEDTLS_ERR_ECP_IN_PROGRESS and then be called later again in order to
 * further progress and eventually complete their operation. This is controlled
 * through mbedtls_ecp_set_max_ops() which limits the maximum number of ECC
 * operations a function may perform before pausing; see
