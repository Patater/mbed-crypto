 ...
 *   #PSA_KEY_TYPE_IS_ECC_PUBLIC_KEY is true), the format is the DER encoding
 *   of the representation defined by RFC 3279 &sect;2.3.5 as `ECPoint`, which
 *   contains the uncompressed representation defined by SEC1 &sect;2.3.3.
 *   ```
 *   ECPoint ::= ...
 *      -- first 8 bits: 0x04;
